...
<head>
    ...
    <style>
        ...
        form input[type="submit"] {
            padding: 10px 20px;
            background-color: #28a745; /* Cambié el color de fondo */
            color: #fff;
            border: none;
            border-radius: 5px;
            cursor: pointer;
        ...
        form input[type="submit"]:hover {
            background-color: #218838; /* Cambié el color de fondo */
        }
...
<div class="container">
    <div class="message-container">
        ...
        <p>Confirme la admisión del usuario.</p>
    </div>
    ...
    <div class="form-container">
        ...
        if(isset($_POST['usuario_id'])) {
            ...
            if(mysqli_num_rows($result) > 0) {
                ...
                echo '<input type="text" id="apellido" name="apellido" class="form-control" value="'.$userData
                ['apellido'].'" readonly>';
                echo '</div>';
                echo '<div class="form-group">';
                ...
                echo '</div>';
                echo '<div class="form-group">';            echo '<label for="rol">Rol:</label>';
                echo '<input type="text" id="rol" name="rol" class="form-control" value="'.$userData['rol_id'].'" readonly>';
                echo '</div>';
    
                // Botón para confirmar la admisión del usuario
                echo '<form id="admitUserForm" action="../Controladores/AdmitirUserAdminController.php" method="POST">';
                ...
                echo '<button type="submit" class="btn btn-success">Admitir Usuario</button>';
                echo '</div>';
                echo '</form>';
            } else {
