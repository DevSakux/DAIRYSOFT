...
<div class="container">
    <div class="message-container">
        ...
        <p>Confirme la eliminación del usuario y tenga en cuenta que esta acción no se puede deshacer.</p>
    </div>
    ...
    <div class="form-container">
        ...
        if(isset($_GET['id'])) {
            ...
            if(mysqli_num_rows($result) > 0) {
                ...
                echo '<form id="deleteUserForm" action="../Controladores/EliminarUserAdminController.php" method="POST">';
