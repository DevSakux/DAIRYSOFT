    ...
    <img src="../public/imagenes/silueta.png" alt="Silueta de persona">
        ...
        ?></p>
            ...
            <ul class="sections">
                ...
                <li><a href="Registroentrada.php" target="iframeContent"><i class="fas fa-box"></i> Productos</a></li>
                <li><a href="RegistroSalida.php" target="iframeContent"><i class="fas fa-chart-bar"></i> Informes</a></li>
                <li><a href="DatosProveedores.php" target="iframeContent"><i class="fas fa-exchange-alt"></i> Movimientos</a></li>
                <li><a href="NumeroSerie.php" target="iframeContent"><i class="fas fa-exclamation-triangle"></i> Alertas</a></li>
                <li><a href="seguimiento.php" target="iframeContent"><i class="fas fa-history"></i> Historial</a></li>

                <!-- Agrega más secciones según sea necesario -->
                <li class="extra-space2"></li>
            </ul>
        ...
        <ul class="sections">
            ...
            <li class="copyright2">&copy; DairySoft 2024</li>
        </ul>
    </div>
